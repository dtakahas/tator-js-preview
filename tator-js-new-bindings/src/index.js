...
* <pre>
* var TatorRestApi = require('index'); // See note below*.
* var xxxSvc = new TatorRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new TatorRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new TatorRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new TatorRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
