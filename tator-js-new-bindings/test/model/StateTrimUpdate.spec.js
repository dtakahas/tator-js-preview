...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TatorRestApi.StateTrimUpdate();
  });
  ...
  describe('StateTrimUpdate', function() {
    it('should create an instance of StateTrimUpdate', function() {
      // uncomment below and update the code to test StateTrimUpdate
      //var instane = new TatorRestApi.StateTrimUpdate();
      //expect(instance).to.be.a(TatorRestApi.StateTrimUpdate);
    });
