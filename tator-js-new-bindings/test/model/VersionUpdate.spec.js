...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TatorRestApi.VersionUpdate();
  });
  ...
  describe('VersionUpdate', function() {
    it('should create an instance of VersionUpdate', function() {
      // uncomment below and update the code to test VersionUpdate
      //var instane = new TatorRestApi.VersionUpdate();
      //expect(instance).to.be.a(TatorRestApi.VersionUpdate);
    });
