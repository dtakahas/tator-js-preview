...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TatorRestApi.LocalizationTypeSpec();
  });
  ...
  describe('LocalizationTypeSpec', function() {
    it('should create an instance of LocalizationTypeSpec', function() {
      // uncomment below and update the code to test LocalizationTypeSpec
      //var instane = new TatorRestApi.LocalizationTypeSpec();
      //expect(instance).to.be.a(TatorRestApi.LocalizationTypeSpec);
    });
