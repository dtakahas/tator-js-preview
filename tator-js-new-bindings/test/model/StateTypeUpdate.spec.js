...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TatorRestApi.StateTypeUpdate();
  });
  ...
  describe('StateTypeUpdate', function() {
    it('should create an instance of StateTypeUpdate', function() {
      // uncomment below and update the code to test StateTypeUpdate
      //var instane = new TatorRestApi.StateTypeUpdate();
      //expect(instance).to.be.a(TatorRestApi.StateTypeUpdate);
    });
