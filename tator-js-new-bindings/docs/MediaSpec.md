...
**url** | **String** | Upload URL for the image if this is an image type. If not an image, this field is ignored. | [optional] 
...
**progressName** | **String** | Replaces name in progress message. | [optional] 
