...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TatorRestApi.LocalizationTypeUpdate();
  });
  ...
  describe('LocalizationTypeUpdate', function() {
    it('should create an instance of LocalizationTypeUpdate', function() {
      // uncomment below and update the code to test LocalizationTypeUpdate
      //var instane = new TatorRestApi.LocalizationTypeUpdate();
      //expect(instance).to.be.a(TatorRestApi.LocalizationTypeUpdate);
    });
