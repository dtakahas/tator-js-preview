...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TatorRestApi.AlgorithmLaunch();
  });
  ...
  describe('AlgorithmLaunch', function() {
    it('should create an instance of AlgorithmLaunch', function() {
      // uncomment below and update the code to test AlgorithmLaunch
      //var instane = new TatorRestApi.AlgorithmLaunch();
      //expect(instance).to.be.a(TatorRestApi.AlgorithmLaunch);
    });
