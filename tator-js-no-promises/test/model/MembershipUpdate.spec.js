...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TatorRestApi.MembershipUpdate();
  });
  ...
  describe('MembershipUpdate', function() {
    it('should create an instance of MembershipUpdate', function() {
      // uncomment below and update the code to test MembershipUpdate
      //var instane = new TatorRestApi.MembershipUpdate();
      //expect(instance).to.be.a(TatorRestApi.MembershipUpdate);
    });
